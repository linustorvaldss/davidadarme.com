...
![client server diagram example](/fe-vs-be/diagrama-cliente-servidor.png)

![client server and database diagram example](/fe-vs-be/diagrama-cliente-servidor-base-de-datos.png)

![3tier architecture diagram example](/fe-vs-be/arquitectura-tres-capas.png)
